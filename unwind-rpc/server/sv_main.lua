...
RegisterNetEvent('unwind-rpc:cl_request')
AddEventHandler('unwind-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('unwind-rpc:cl_response', src, origin, callId, response)
end)
